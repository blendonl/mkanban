...
class BoardPersistence:
    ...
    def save_item_to_column(self, board_name: str, column_name: str, item_data: dict) -> None:
    ...
    def delete_item_from_column(self, board_name: str, column_name: str, item_id: ItemId) -> bool:
        board_dir = get_board_directory_path(self.boards_dir, board_name)
        column_dir = get_column_directory_path(board_dir, column_name)
    ...
    def cleanup_column(self, board_name: str, column_name: str, current_item_ids: set[ItemId]) -> None:
        board_dir = get_board_directory_path(self.boards_dir, board_name)
        column_dir = get_column_directory_path(board_dir, column_name)
