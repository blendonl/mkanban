...
class TaskCreator:
    ...
    def _find_target_column(self, board, column_name: str):
        ...
        if not target_column and board.columns:
            ...
            click.echo(
                f"Column '{column_name}' not found. Using first column '{target_column.name}' instead."
            )
...
"""
    ...
    def show_current_task(self, board_name: str, column_name: str) -> None:
        ...
        try:
            ...
            click.echo(
                f"Opened task '{first_item.title}' from column '{target_column.name}'"
            )
    ...
    def _open_editor_for_current_task(self, file_path: str) -> None:
        ...
        try:
            ...
            click.echo(
                f"Error: {editor} not found. Please install {editor} or set EDITOR environment variable"
            )
            raise
